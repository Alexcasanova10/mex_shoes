              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="mt-6">
                    <Link
                      to="/placeorder"
                      className="flex items-center justify-center  border border-transparent bg-[#050708] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-[#050708]/80"
                    >
                      Checkout
                    </Link>
                  </div>
